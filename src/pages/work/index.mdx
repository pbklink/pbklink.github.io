...
- <Link
    url={currentMotifMarketsPage.url}
    text="Managing director at Motif Markets"
  />
- <Link
    url={currentProductivityExchangePage.url}
    text="CEO of The Productivity Exchange"
  />
- <Link
    url={historyPage.url}
    text="Previous jobs"
