...
import frustratedApplicationSubmitterImage from './_frustrated-application-submitter.webp';

<MaxWidthImage
  src={frustratedApplicationSubmitterImage}
  alt="Frustrated application submitter"
  center={true}
/>
