...
- productivity
- R&D
summary: "To increase the level of R&D in a country, government support should target both the supply and demand sides of the market for innovation."
---

The R&D process is not very attractive[^1] to businesses.  It is high risk, has low productivity, and requires expensive talent.  A few businesses manage to incorporate it into their business model.  However most do not, and are happy to adopt the output of other organisations’ R&D.

On the other hand, governments love the R&D process.  Estimates of private rate of returns to R&D from numerous studies[^2] cluster around 10% to 15% (but can be significantly higher).  Studies have also estimated the social rate of returns from R&D, from side-effects such as [spillover](https://paul.klink.au/articles/understanding-rd-subsidies/#ideas--spillover) and enhanced ability to adopt innovation.  These estimates range up to 100%.  Accordingly governments make great efforts to increase the levels of R&D within their economy.
