...
export default defineConfig({
  ...
  redirects: {
      ...
      '/c-sharp-library/examples/write_headings.html': '/software/fielded-text/c-sharp-library/examples/csharp-writing-of-csv-file-including-headings/',
      '/c-sharp-library/examples/write_events.html': '/software/fielded-text/c-sharp-library/examples/csharp-writing-of-csv-file-using-events/',
      '/c-sharp-library/examples/write_comments.html': '/software/fielded-text/c-sharp-library/examples/csharp-writing-of-csv-file-with-comments/',
      ...
      '/delphi-library/examples/basicread.html': '/software/fielded-text/delphi-library/examples/delphi-basic-reading-of-csv-file/',
      '/delphi-library/examples/basicwrite.html': '/software/fielded-text/delphi-library/examples/delphi-basic-writing-of-csv-file/',
